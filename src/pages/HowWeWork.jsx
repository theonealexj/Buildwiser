    ...
    <>
      ...
      <section className="page-section hww-overview">
        <div className="container hww-overview-grid">
          <div className="hww-overview-left reveal">
            <div className="section-label">Our Approach</div>
            <h2 className="section-headline">Structured from<br />the first conversation.</h2>
            <p className="wwd-body">We do not begin with a proposal. We begin with understanding. The business is reviewed as an integrated system before any recommendation is made.</p>
            <p className="wwd-body">Our process is defined in advance. The scope, the phases, and the expected outputs are agreed before work begins.</p>
          </div>
            ...
            <div className="hww-phase-card" id="phase-1">
              <div className="hww-phase-header">
                ...
                <div className="hww-phase-meta">
                  ...
                  <span className="hww-phase-time">2 – 4 Weeks</span>
                </div>
              </div>
            ...
            <div className="hww-phase-card" id="phase-2">
              <div className="hww-phase-header">
                ...
                <div className="hww-phase-meta">
                  ...
                  <span className="hww-phase-time">3 – 5 Weeks</span>
                </div>
              </div>
            ...
            <div className="hww-phase-card" id="phase-3">
              <div className="hww-phase-header">
                ...
                <div className="hww-phase-meta">
                  ...
                  <span className="hww-phase-time">8 – 16 Weeks</span>
                </div>
              </div>
            ...
            <div className="hww-phase-card" id="phase-4">
              <div className="hww-phase-header">
                ...
                <div className="hww-phase-meta">
                  ...
                  <span className="hww-phase-time">4 – 6 Weeks</span>
                </div>
              </div>
      ...
      <section className="page-section hww-models">
        <div className="container">
          ...
          <h2 className="section-headline reveal reveal-delay-1">Work is delivered through<br />structured engagements.</h2>
